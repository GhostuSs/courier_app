                            ...
                            ActionSlider.standard(
                              ...
                              action: (_) async =>
                                  Get.dialog(CupertinoAlertDialog(
                                    title: Text(
                                        'Вы ${controller.selectedOrder.value.status == OrderStatuses.courier
                                            ? "доставили"
                                            : "забрали"} заказ?'),
                                    content: Text(
                                        'Подтвердите, что ${controller.selectedOrder.value.status ==
                                            OrderStatuses.courier
                                            ? "заказ доставлен получателю"
                                            : "забрали заказ и выезжайте на адрес доставки"}'),
                                    actions: [
                    ...
                    child: SafeArea(
                        ...
                        child: Column(
                          ...
                          children: [
                                ...
                                children: [
                                  Row(
                                    ...
                                    children: [
                                      ...
                                      InkWell(
                                        onTap: () =>
                                        controller.selectedOrder.value.address_1 != null
                                            ? MapsLauncher.launchQuery(controller.selectedOrder.value.address_1 ?? '')
                                            : print('-'),
                            ...
                            if(controller.selectedOrder.value.phone != null) InkWell(
                              onTap: () =>
                                  _makePhoneCall(
                              ...
                              child: Container(
                                padding: const EdgeInsets.all(16),
                                decoration: BoxDecoration(
                                    borderRadius: BorderRadius.circular(10.r), color: AppColors.gray3),
                                child: Row(
                                  mainAxisAlignment: MainAxisAlignment.spaceBetween,
                                  children: [
                                    RichText(
                                    ...
                                    Assets.images.phone.svg(width: 24.sp,)
                                  ],
                                ),),
                            ),
                            Padding(
